              ...
              <div className="space-y-2">
                {skillCategory.technologies.map((tech, techIndex) => (
                  <motion.span
                    ...
                    viewport={{ once: true }}
                    className="inline-block bg-gray-100 text-gray-700 px-3 py-1 rounded-full text-sm font-medium mr-2 mb-2 hover:bg-blue-100 hover:text-blue-700 transition-colors"
                  >
                    {tech}
                  </motion.span>
                ))}
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {["TypeScript", "MongoDB", "Axios", "Cheerio", "Salesforce Marketing Cloud", "BigQuery", "Looker Studio", "VPS Management", "API Development"].map((tech, index) => (
              <motion.span
                ...
                viewport={{ once: true }}
                className="px-4 py-2 bg-gradient-to-r from-gray-100 to-gray-200 text-gray-700 rounded-full text-sm font-medium hover:from-blue-100 hover:to-blue-200 hover:text-blue-700 transition-all duration-300 cursor-default"
              >
                {tech}
              </motion.span>
            ))}
